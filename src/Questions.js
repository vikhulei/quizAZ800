const Questions = {
  ...
  VMs_and_Containers: [
    ...
    {q: 'What is a container?', a: 'Container is a lightweight development and runtime environment, abstract from OS, in which applications can be run and shared easely during development', tag: 0},
    {q: '', a: '', tag: 0},
    {q: '', a: '', tag: 0},
    {q: '', a: '', tag: 0},
    {q: '', a: '', tag: 0},
